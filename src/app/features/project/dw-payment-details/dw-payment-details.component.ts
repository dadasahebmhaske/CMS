...
export class DwPaymentDetailsComponent implements OnInit, OnDestroy {
                      ...
                      public MaterialArray: any = [];WeeklyPayoutArray:any=[];
                      public WeeklyPayoutData: any = [];editflag;
                   ...
                   // onSelectActivityMaterial() {
                    ...
                    public onSelectProject(TranNo,RefTranNo) {
                      ...
                      this.projectService.getDWprojectexweeklypayout(tranNo,this.project.ProjectId,RefTranNo).subscribe((resData: any) => {
                        if (resData.StatusCode != 0) {
                        if(RefTranNo==''){ 
                          this.ExecutiveData = resData.Data.Table;
                          this.WeeklyPayoutData=resData.Data.Table1;
                          if (this.project.TranNo != null) {
                            this.onSelectProjectExecutive();
                          }
                        }
                    ...
                    onSelectProjectExecutive() {
                      this.WeeklyPayoutArray = this.projectService.filterData(this.WeeklyPayoutData, this.project.ProjectExecutiveId, 'ProjectExecutiveId');
                    }
