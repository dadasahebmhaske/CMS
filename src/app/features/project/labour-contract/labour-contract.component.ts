...
export class LabourContractComponent implements OnInit, OnDestroy {
              ...
              ngOnInit() {
                this.datashare.GetSharedData.subscribe(data => this.transport = data == null ? { IsActive: 'Y',SiteId:'',PaymentTermId:'',PManageId:'',ProjectId:'',MaterialId:'',MaterialTypeId:'',RoleCode:'',RateType:'' } : data);
