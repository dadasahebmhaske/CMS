...
@Component({
  selector: 'sa-labour-work-payment-deatils-list',
  templateUrl: './labour-work-payment-deatils-list.component.html',
  styleUrls: ['./labour-work-payment-deatils-list.component.css']
})
export class LabourWorkPaymentDeatilsListComponent implements OnInit {
                  ...
                  public LabourContractData: any={};LabourWorkPaymentData:any=[];
                  ...
                  onEditFunction = ($event) => {
                    ...
                    AppComponent.Router.navigate(['/project/labour-work-payment-details']);
                  }
                  ...
                  LabourContractAction(action, TranNo) {
                    ...
                    Swal.fire({
                      ...
                      if (result.value) {
                        switch (action) {
                          case 'Delete':
                            this.projectService.getDeleteTransaction(TranNo, 112).subscribe((resData: any) => {
                          ...
                          //   break;
                          case 'Approve':
                            this.projectService.getApprove(TranNo, 112, this.cpInfo.EmpId).subscribe((resData: any) => {
                              if (resData.StatusCode != 0) {
                                this.onLoad();
                                AppComponent.SmartAlert.Success(resData.Message);
                              }
                  ...
                  onLoad() {
                    ...
                    this.projectService.getTransactionlist(112,this.Filter).subscribe((resData: any) => {
                      this.loaderbtn=true;
                      if (resData.StatusCode != 0) {
